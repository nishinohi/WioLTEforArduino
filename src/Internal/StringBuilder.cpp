...
StringBuilder::StringBuilder() { _Buffer.push_back('\0'); }
...
int StringBuilder::Length() const { return _Buffer.size() - 1; }

const char *StringBuilder::GetString() const { return &_Buffer[0]; }
