...
class AtSerial {
  private:
    ...
    bool ReadResponseInternal(const char *pattern, unsigned long timeout, std::string *response,
  ...
  public:
    ...
    bool WriteCommandAndReadResponse(const char *command, const char *pattern,
