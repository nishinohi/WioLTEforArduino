...
WioLTEClient::~WioLTEClient() { delete[] _ReceiveBuffer; }
...
uint8_t WioLTEClient::connected() { return _ConnectId >= 0 ? true : false; }

WioLTEClient::operator bool() { return _ConnectId >= 0 ? true : false; }
